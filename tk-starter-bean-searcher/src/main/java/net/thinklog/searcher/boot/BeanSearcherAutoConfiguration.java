package net.thinklog.searcher.boot;
...
public class BeanSearcherAutoConfiguration {
    ...
    public PageExtractor pageExtractor(BeanSearcherProperties config) {
        ...
        if (BeanSearcherProperties.Params.PaginationProps.TYPE_PAGE.equals(type)) {
            ...
            extractor = p;
        } else if (BeanSearcherProperties.Params.PaginationProps.TYPE_OFFSET.equals(type)) {
    ...
    public Dialect dialect(BeanSearcherProperties config) {
        ...
        switch (dialect.toLowerCase()) {
            case BeanSearcherProperties.Sql.DIALECT_MYSQL:
                return new MySqlDialect();
            case BeanSearcherProperties.Sql.DIALECT_ORACLE:
